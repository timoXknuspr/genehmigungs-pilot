...
# HINWEIS: Wir verwenden Flask, einen kleinen Webserver, um die App zu hosten.
...
# Ein einfacher Speicher für laufende Anfragen.
# Für eine echte Produktions-App würde man eine Datenbank (z.B. Redis) verwenden.
PENDING_REQUESTS = {}
...
def handle_approval_buttons(ack, body, client):
    ...
    outputs = {"decision": "Genehmigt"} if decision == "approve" else {"decision": "Abgelehnt"}
...
# Route, um auf alle Anfragen von Slack zu lauschen
